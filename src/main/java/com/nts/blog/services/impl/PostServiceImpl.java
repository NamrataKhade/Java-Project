...
import com.nts.blog.services.PostService;
...
public class PostServiceImpl implements PostService {
	...
	//	int pageNumber=1;
		...
		List<PostDto> postDtos = allPost.stream().map((posts)->this.modelMapper.map(posts,PostDto.class)).collect(Collectors.toList());
